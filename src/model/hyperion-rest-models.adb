...
package body Hyperion.Rest.Models is
   ...
   procedure Serialize (Into  : in out Swagger.Streams.Output_Stream'Class;
                        Name  : in String;
                        Value : in Body_1_Type_Vectors.Vector) is
   begin
   ...
   procedure Deserialize (From  : in Swagger.Value_Type;
                          Name  : in String;
                          Value : out Body_1_Type_Vectors.Vector) is
   ...
   procedure Serialize (Into  : in out Swagger.Streams.Output_Stream'Class;
                        Name  : in String;
                        Value : in Dataset_Type_Vectors.Vector) is
   begin
      Into.Start_Array (Name);
      for Item of Value loop
         Serialize (Into, "", Item);
   ...
   procedure Deserialize (From  : in Swagger.Value_Type;
                          Name  : in String;
                          Value : out Dataset_Type_Vectors.Vector) is
      List : Swagger.Value_Array_Type;
      Item : Dataset_Type;
   begin
      Value.Clear;
